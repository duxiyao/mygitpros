...
import org.myframe.http.HttpHeaderParser;
import org.myframe.http.KJHttpException;
import org.myframe.http.NetworkResponse;
import org.myframe.http.Request;
import org.myframe.http.Response;
    ...
    public Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
        synchronized (sDecodeLock) {
            try {
                ...
                MLoger.debug("Caught OOM for %d byte image, url=%s",
